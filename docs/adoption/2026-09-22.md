...
Generated from the `2026-09-22` snapshot at `2026-09-22T08:31:56.144Z`.
...
**Coverage:** 14/14 npm days observed (success); 56/56 GitHub daily values observed (views success, clones success); public evidence partial. GitHub windows: unique cloners `2026-09-22` (current snapshot), unique viewers `2026-09-22` (current snapshot).
...
[![Daily npm downloads for the 14 days before 2026-09-22; missing days are gaps and the latest observation is labeled.](./assets/2026-09-22/npm-downloads.svg)](./assets/2026-09-22/npm-downloads.svg)

### Daily GitHub activity

[![Daily GitHub clones and views for the 14 days before 2026-09-22; clones use a solid line with circles and views use a dashed line with squares.](./assets/2026-09-22/github-traffic.svg)](./assets/2026-09-22/github-traffic.svg)

### Downloads by released version

[![Newest npm rolling version-download snapshot; the highest stable version observed is explicitly labeled and chart overflow is grouped as Other versions.](./assets/2026-09-22/version-downloads.svg)](./assets/2026-09-22/version-downloads.svg)
...
Period: `2026-09-08` through `2026-09-21`. Source status: **success**.
...
| --- | --- | --- | --- | --- |
| Views | 2026-09-22 | current snapshot | 71 | observed |
| Unique viewers | 2026-09-22 | current snapshot | 18 | observed |
| Clones | 2026-09-22 | current snapshot | 527 | observed |
| Unique cloners | 2026-09-22 | current snapshot | 125 | observed |

### npm version snapshot

Snapshot date: `2026-09-22` (current snapshot). This is npm's rolling version-level snapshot; it is separate from daily package downloads. Every exact version remains in this table even when the chart groups overflow.

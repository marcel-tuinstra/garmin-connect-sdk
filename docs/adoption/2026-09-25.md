...
Generated from the `2026-09-25` snapshot at `2026-09-25T08:48:13.941Z`.
...
**Coverage:** 14/14 npm days observed (success); 52/56 GitHub daily values observed (views partial (missing_dates), clones partial (missing_dates)); public evidence partial. GitHub windows: unique cloners `2026-09-25` (current snapshot), unique viewers `2026-09-25` (current snapshot).
...
[![Daily npm downloads for the 14 days before 2026-09-25; missing days are gaps and the latest observation is labeled.](./assets/2026-09-25/npm-downloads.svg)](./assets/2026-09-25/npm-downloads.svg)

### Daily GitHub activity

[![Daily GitHub clones and views for the 14 days before 2026-09-25; clones use a solid line with circles and views use a dashed line with squares.](./assets/2026-09-25/github-traffic.svg)](./assets/2026-09-25/github-traffic.svg)

### Downloads by released version

[![Newest npm rolling version-download snapshot; the highest stable version observed is explicitly labeled and chart overflow is grouped as Other versions.](./assets/2026-09-25/version-downloads.svg)](./assets/2026-09-25/version-downloads.svg)
...
Period: `2026-09-11` through `2026-09-24`. Source status: **success**.
...
| 2026-09-23 | 0 | observed |
| 2026-09-24 | 0 | observed |
...
| --- | --- | --- | --- | --- |
| Views | 2026-09-25 | current snapshot | 100 | observed |
| Unique viewers | 2026-09-25 | current snapshot | 17 | observed |
| Clones | 2026-09-25 | current snapshot | 606 | observed |
| Unique cloners | 2026-09-25 | current snapshot | 152 | observed |

### npm version snapshot

Snapshot date: `2026-09-25` (current snapshot). This is npm's rolling version-level snapshot; it is separate from daily package downloads. Every exact version remains in this table even when the chart groups overflow.
